...
3.  Forhåndsdefinerte verdier - I disse feltene kan du velge mellom et antall forhåndsdefinerte verdier. Det gjelder alle statusfeltene :
    ...
    - **Status Økonomi**
    - **Status kvalitet**
    - **Status risiko** [(mer informasjon om rapporten under Usikkerhet)](https://docs.puzzlepart.com/prosjektportalen-manual-kladd/Brukermanual/4%20Prosjekt/4.6-Usikkerhet.html)
    - **Status muligheter**
